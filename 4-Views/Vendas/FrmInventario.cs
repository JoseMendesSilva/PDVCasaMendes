...
namespace CasaMendes
{
    public partial class FrmInventario : Form
    {
        ...
        ////public List<PreVenda> ListaPreVenda;
        ...
        //            //oPreV.TipoDeVenda = "A VISTA"; // Só para testar o código.
        ...
        //                    this.Refresh();
        //                    Arrumado = true;
        //                   var ListaPreVenda = dados.Select<PreVenda>($"select * from PreVendas where TipoDeVenda = '{oPreV.TipoDeVenda.ToString().ToUpper()}' and ClienteId = {oPreV.ClienteId};");
        //                    DgvVendas.DataSource = ListaPreVenda;
        //                }
        //            }
        ...
        //        var frm = new FrmFrenteDeCaixa();
                
        //        frm.Show();
        //        frm.CarregarPendura(ClienteId, TipoDeVenda);
        //        frm.Visible = true;
        ...
        //            using (var dados = new Dados())
        //            {
        //                var result = dados.Select<Cliente>("select * from Clientes");
        ...
        //            }
        //            if (this.dgvClientes.Rows.Count > 0) this.dgvClientes.Columns["Nome"].Visible = true;
        //            RedimencionarColunas();
        //            Arrumado = false;
        //            dgvClientes.Focus();
        //        }
