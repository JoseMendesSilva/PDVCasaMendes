...
namespace CasaMendes
{
    public partial class FrmTabelaDeMargen : Form
    {
        ...
        //private async Task OrganizarColunasSubcategoria()
        //{
        ...
        //private async Task OrganizarColunasTabelaDeMargen()
        //{
        ...
        //private async Task CalcularPorcentagemPeso()
        //{
        //    try
        //    {
        ...
        //private async void DgvSubcategorias_CellEnter(object sender, DataGridViewCellEventArgs e)
        //{
        ...
        //   await OrganizarColunasTabelaDeMargen();
        //}

        //private async void DgvTabelaDeMargem_CellEnter(object sender, DataGridViewCellEventArgs e)
        //{
        //    try
        //    {
        ...
        //private async void TxtCusto_TextChanged(object sender, EventArgs e)
        //{
        //    try
        //    {
        //        if (this.TxtCusto.Text.Equals("")) return;
        //        oTabelaDeMargen.Custo = clsGlobal.DeStringParaDecimal(this.TxtCusto.Text);
        //        if (oTabelaDeMargen.Custo > 0) await Calcular();
        //    }
        //    catch { }
        //}

        //private async void TxtMargemDeLucro_TextChanged(object sender, EventArgs e)
        //{
        //    try
        //    {
        //        if (this.TxtMargemDeLucro.Text.Equals("")) return;
        //        oTabelaDeMargen.MargemDeLucro = clsGlobal.DeStringParaDecimal(this.TxtMargemDeLucro.Text);
        //        if (oTabelaDeMargen.MargemDeLucro > 0) await Calcular();
        //    }
        //    catch { }
        //}

        //private async void TxtDespesa_TextChanged(object sender, EventArgs e)
        //{
        //    try
        //    {
        //        if (this.TxtDespesa.Text.Equals("")) return;
        //        oTabelaDeMargen.Despesa = clsGlobal.DeStringParaDecimal(this.TxtDespesa.Text);
        //        if (oTabelaDeMargen.Despesa > 0) await Calcular();
        //    }
        //    catch { }
        //}

        //private async void TxtEncargo_TextChanged(object sender, EventArgs e)
        //{
        //    try
        //    {
        //        if (this.TxtEncargo.Text.Equals("")) return;
        //        oTabelaDeMargen.Encargo = clsGlobal.DeStringParaDecimal(this.TxtEncargo.Text);
        //        if (oTabelaDeMargen.Encargo > 0) await Calcular();
        //    }
        //    catch { }
        //}
        ...
        //        //DgvSubcategorias.DataSource = await oSubCategoria.Busca();
        //    }
        //    catch { }
        //}

        //private async void TxtValorDeBase_TextChanged(object sender, EventArgs e)
        //{
        //  await CalcularPorcentagemPeso();
        //}

        //private async void TxtNumeroDeItensNaLoja_TextChanged(object sender, EventArgs e)
        //{
        //  await  CalcularPorcentagemPeso();
        //}

        //private async void TxtPorcentagemPesoPorItem_TextChanged(object sender, EventArgs e)
        //{
        //    try
        //    {
        ...
        //    }
        //   await LerDados();
        //   var rowsAffected = await oTabelaDeMargen.Salvar();
        //    DgvTabelaDeMargem.DataSource = await oTabelaDeMargen.Busca();
        ...
        //private async void FrmTabelaDeMargen_Shown(object sender, EventArgs e)
        //{
        //    try
        //    {
        //       // Loading = true;
        ...
        //       // }
        //       //await OrganizarColunasSubcategoria();
        //       // Loading = false;
        //       // Loadining = false;
        //       // TxtNumeroDeItensNaLoja.Text = "67";
        //       // TxtValorDeBase.Text = "1228,07";
